...
class AppColors {
  ...
  static const Color cardShadow = Color(0x0C2B1B12);

  // 4 Roles Unified Accent Palette (All matching the Warm Artisan Terracotta theme)
  // 1. Gig Worker
  static const Color gigWorker = Color(0xFF8B3E0C);
  static const Color gigWorkerLight = Color(0xFFFFF7ED);
  static const Color gigWorkerDark = Color(0xFF6B2E07);

  // 2. Product Seller
  static const Color productSeller = Color(0xFF8B3E0C);
  static const Color productSellerLight = Color(0xFFFFF7ED);
  static const Color productSellerDark = Color(0xFF6B2E07);

  // 3. Business Owner
  static const Color businessOwner = Color(0xFF8B3E0C);
  static const Color businessOwnerLight = Color(0xFFFFF7ED);
  static const Color businessOwnerDark = Color(0xFF6B2E07);

  // 4. Community Org
  static const Color communityOrg = Color(0xFF8B3E0C);
  static const Color communityOrgLight = Color(0xFFFFF7ED);
  static const Color communityOrgDark = Color(0xFF6B2E07);
}
